...
public class TaskDeleteServletTest extends Mockito {
  ...
  public void setUp() {
    ...
    servlet = new TaskDeleteServlet(datastore);
  ...
  public void testDoPost() throws IOException, ServletException {
    ...
    TaskData task = new TaskData(0l, 1l, "name", "description");

    // Add task to datastore with TaskController
